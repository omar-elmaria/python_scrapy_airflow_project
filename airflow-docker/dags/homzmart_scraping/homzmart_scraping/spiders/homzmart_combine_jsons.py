...
path_to_json_airflow = '/opt/airflow/data' # For the Airflow DAG
path_to_json_local_env = '/home/oelmaria/python_projects/python_scrapy_project/airflow-docker/data' # For running the script locally
...
class CombineJsons():
    ...
    try:
        json_files = [pos_json for pos_json in os.listdir(path_to_json_airflow) if pos_json.endswith('.json')] # List the JSON files via the Airflow JSON path
        path_to_json = path_to_json_airflow # Specify the final JSON path to the Airflow path
    except FileNotFoundError:
        json_files = [pos_json for pos_json in os.listdir(path_to_json_local_env) if pos_json.endswith('.json')] # List the JSON files via the local env JSON path
        path_to_json = path_to_json_local_env # Specify the final JSON path to the local env path
